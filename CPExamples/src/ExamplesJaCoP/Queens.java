...
public class Queens extends Example {
	...
	public static void test(String args[]) {
            ...
            System.out.println("TESTUJE MODEL");
		Queens example = new Queens();
		...
		if (example.searchSmallestMiddle())
			System.out.println("Solution(s) found 1");		

                
                System.out.println("TESTUJE MODEL BASIC");
		example = new Queens();
		...
		if (example.searchLDS(3))
			System.out.println("Solution(s) found 2");
		
                
                System.out.println("TESTUJE MODEL CHANNELING");
		example = new Queens();
