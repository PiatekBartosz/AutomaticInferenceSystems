...
public class clp_combi {
	...
	System.out.println("Program to solve Zebra problem");
        ...
        // 1
        store.impose(new Or(
                new And(new XplusCeqZ(color[iwhite], 1, names[iFrank]),new XplusCeqZ(names[iFrank], 1, profession[iweb])), 
                new And( new XplusCeqZ(profession[iweb], 1, names[iFrank]),new XplusCeqZ(names[iFrank], 1, color[iwhite]))));
        
        // 2
        store.impose(new Or(new XeqC(profession[itechnician], 1), new XeqC(profession[itechnician], 5)));
        store.impose(new Or(new XplusCeqZ(profession[itechnician], 1, color[iyellow]), new XplusCeqZ(profession[itechnician], -1, color[iyellow])));
        ...
        // 7
        store.impose(new Or(new XplusCeqZ(color[iblue], 1, names[iDamian]), new XplusCeqZ(color[iblue], -1, names[iDamian])));
        ...
        // 10
        store.impose(new Or(new XplusCeqZ(profession[iPLC], 1, names[iPaul]), new XplusCeqZ(profession[iPLC], -1, names[iPaul])));
        // MODEL END
